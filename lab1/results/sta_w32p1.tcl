...
# Tokens ../pdk/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib, 32, 1 substituted by Makefile.
#
# This script:
...
read_verilog results/netlist_32_1.v
link_design registered_adder

read_sdc results/constraints_w32p1.sdc
...
write_sdf results/netlist_32_1.sdf
