...
# Tokens ../pdk/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib, 16, 16 substituted by Makefile.
#
# This script:
...
read_verilog results/netlist_16_16.v
link_design registered_adder

read_sdc results/constraints_w16p16.sdc
...
write_sdf results/netlist_16_16.sdf
