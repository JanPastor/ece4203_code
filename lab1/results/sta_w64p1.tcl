...
# Tokens ../pdk/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib, 64, 1 substituted by Makefile.
#
# This script:
...
read_verilog results/netlist_64_1.v
link_design registered_adder

read_sdc results/constraints_w64p1.sdc
...
write_sdf results/netlist_64_1.sdf
