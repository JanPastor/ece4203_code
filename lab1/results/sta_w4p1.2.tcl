...
# Tokens ../pdk/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib, 4, 1.2 substituted by Makefile.
#
# This script:
...
read_verilog results/netlist_4_1.2.v
link_design registered_adder

read_sdc results/constraints_w4p1.2.sdc
...
write_sdf results/netlist_4_1.2.sdf
