...
# Tokens ../pdk/sky130_fd_sc_hd/lib/sky130_fd_sc_hd__tt_025C_1v80.lib, 16, 4 substituted by Makefile.
#
# This script:
...
read_verilog results/netlist_16_4.v
link_design registered_adder

read_sdc results/constraints_w16p4.sdc
...
write_sdf results/netlist_16_4.sdf
